...
class Square{
    ...
    draw(text, textColor){
       return  `<svg width="300" height="200">
        ...
        <text x="50" y="50" dominant-baseline="middle" text-anchor="middle" fill="${textColor}" font-family="Times New Roman, Times, serif" font-size="24">${text}</text>
        </svg>`;
    }
}
...
class Triangle{
    ...
    return  `<svg width="300" height="200">
        ...
        <text x="50" y="60" dominant-baseline="middle" text-anchor="middle" fill="${textColor}" font-family="Times New Roman, Times, serif" font-size="24">${text}</text>
        </svg>`;
    }
}
