...
describe('Square', () => {
    it('should render a square with the correct color', () =>{
        ...
        <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="red" font-family="Times New Roman, Times, serif" font-size="24" text-anchor="middle" alignment-baseline="middle" >text</text>
        </svg>`);
    });
});
...
describe('Triangle', () => {
    it('should render a square with the correct color', () =>{
        ...
        <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="blue" font-family="Times New Roman, Times, serif" font-size="24" text-anchor="middle" alignment-baseline="middle">text</text>
        </svg>`);
    });
});